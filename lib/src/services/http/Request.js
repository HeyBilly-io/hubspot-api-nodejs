...
class Request {
    ...
    applyAuth() {
        ...
        if (authType) {
            const method = (0, get_1.default)(AuthTypes_1.AuthTypes, authType);
            const value = (0, get_1.default)(this.config, authType);
    ...
    initHeaders() {
        if ((0, get_1.default)(this.opts, 'defaultJson', true)) {
    ...
    setBody() {
        if (this.opts.body) {
            ...
            if ((0, get_1.default)(this.headers, 'Content-Type') === 'application/json' && (0, get_1.default)(this.opts, 'defaultJson', true)) {
